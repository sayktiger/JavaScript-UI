...
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../core */ "./src/js/lib/core.js");
...
_core__WEBPACK_IMPORTED_MODULE_15__["default"].prototype.html = function (content) {
  for (var i = 0; i < this.length; i++) {
    if (content) {
...
_core__WEBPACK_IMPORTED_MODULE_15__["default"].prototype.eq = function (i) {
  var swap = this[i];
...
_core__WEBPACK_IMPORTED_MODULE_15__["default"].prototype.index = function () {
  var _this = this;
...
_core__WEBPACK_IMPORTED_MODULE_15__["default"].prototype.find = function (selector) {
  var numberOfItems = 0;
  var counter = 0;
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.toggleClass = function () {
  for (var i = 0; i < this.length; i++) {
    var _this$i$classList3;
    if (!this[i].classList) {
      continue;
    }
    (_this$i$classList3 = this[i].classList).toggle.apply(_this$i$classList3, arguments);
  }
  return this;
};
